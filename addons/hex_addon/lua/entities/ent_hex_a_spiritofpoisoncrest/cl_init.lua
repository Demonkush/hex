...
function ENT:Initialize()
	...
	self.prop_a1:SetColor(Color(235,255,215))
	...
	self.prop_a2:SetColor(Color(235,255,215))

	self.prop_a1:SetSkin(1)
	self.prop_a2:SetSkin(1)
...
function ENT:Draw()
	...
	render.DrawSprite(self:GetPos()+Vector(0,0,15), siz*24, siz*24, Color( 215, 255, 155, 185 ))
	...
	if RealTime() > self.NextEmit then
		...
		particle:SetColor( 215, 255, 155, math.random(15,215) )
