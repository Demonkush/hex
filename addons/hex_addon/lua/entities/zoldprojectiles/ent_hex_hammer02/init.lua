...
function ENT:Explode()
	...
	util.Effect( "fx_hex_hammerblast02", fx )
	self.Entity:EmitSound( "wc3sound/exp/FireBallMissileDeath.wav", 95, math.random(75,85) )
	...
	for _, v in ipairs(ents.FindInSphere( self:GetPos(), 175 )) do
		if v != self:GetOwner() then
			...
			dmginfo:SetDamage( math.random(27,32) )
