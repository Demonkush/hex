...
function ENT:Draw()
    ...
    local ind = "hexgm/ui/aura_frost.png"

    if tr.Hit then
        cam.Start3D2D( tr.HitPos+Vector(0,0,1), Angle(0,0,0), 1 )
            surface.SetDrawColor( Color(155,215,255,10) )
	...
	local particle = emitter:Add("hexgm/sprites/hexbit06", self:GetPos() + Vector(math.random(-5,5),math.random(-5,5),math.random(0,25)) )
		...
		particle:SetColor( 155, math.random(155,215), 255 ) 
