...
function ENT:Initialize()
	...
	timer.Simple(8,function() if IsValid(self) then self.AlphaDir = 1 end end)
end
...
function ENT:Draw()
    local ind = "hexgm/ui/aura_support.png"
    cam.Start3D2D( self:GetPos()+Vector(0,0,1), Angle(0,0,0), 1 )
        surface.SetDrawColor( Color(195,215,255,math.Clamp(self.RingAlpha,0,75)) )
