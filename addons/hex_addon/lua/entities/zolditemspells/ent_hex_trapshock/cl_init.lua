...
function ENT:Draw()
    ...
    local ind = "hexgm/ui/aura_storm.png"

    if tr.Hit then
        cam.Start3D2D( tr.HitPos+Vector(0,0,1), Angle(0,0,0), 1 )
            surface.SetDrawColor( Color(195,215,255,5) )
	...
	local particle = emitter:Add("hexgm/sprites/hexbitstatic", self:GetPos() + Vector(math.random(-5,5),math.random(-5,5),math.random(0,5)) )
		particle:SetVelocity(Vector(0,0,0))
		particle:SetDieTime(math.random(0.3,0.5))
		particle:SetStartSize(math.random(25,35))
		particle:SetStartAlpha(25)
		particle:SetEndAlpha(0)
		particle:SetColor( 155, math.random(155,235), 255 ) 
