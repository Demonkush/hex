...
function ENT:Initialize()
	...
	self.prop_a1:SetColor(Color(255,235,215))
	...
	self.prop_a2:SetColor(Color(255,235,215))
...
function ENT:Draw()
	...
	render.DrawSprite(self:GetPos()+Vector(0,0,15), siz*24, siz*24, Color( 255, 235, 215, 185 ))
	...
	if RealTime() > self.NextEmit then
		...
		particle:SetColor( 255, 235, 215, math.random(15,215) )
