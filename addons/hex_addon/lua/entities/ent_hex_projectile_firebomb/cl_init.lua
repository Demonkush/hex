...
function ENT:Draw()
	...
	if RealTime() > self.NextEmit then
		...
		particle:SetVelocity(VectorRand()*105)
		...
		particle:SetColor(math.random(225,255),math.random(75,115),55,255)
	...
	if RealTime() > self.NextEmit2 then
		...
		particle:SetGravity(Vector(0,0,-32))
		particle:SetAirResistance(0)
		particle:SetColor(math.random(215,225),math.random(75,115),55,255)
