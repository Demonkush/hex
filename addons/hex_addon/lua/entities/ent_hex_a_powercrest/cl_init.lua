...
function ENT:Initialize()
	...
	self.prop_a1:SetColor(Color(255,255,255))
	...
	self.prop_a2:SetColor(Color(255,255,255))
...
function ENT:Draw()
	...
	render.DrawSprite(self:GetPos()+Vector(0,0,15), siz*24, siz*24, Color( 255, 255, 255, 185 ))
	...
	if RealTime() > self.NextEmit then
		...
		particle:SetColor( math.random(155,255), math.random(155,255), math.random(155,255), math.random(15,215) )
