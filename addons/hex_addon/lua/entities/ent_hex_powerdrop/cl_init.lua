...
function ENT:Think()
	...
	if ( dlight ) then
        ...
        dlight.Size              = 64
        dlight.Decay             = 800
        dlight.R                 = math.random(215,255)
        dlight.G                 = math.random(215,255)
        dlight.B                 = math.random(215,255)
        dlight.Brightness        = 3
...
function ENT:Draw()
	...
	particle:SetVelocity( (VectorRand() * 15)+Vector(0,0,55) )
	...
	particle:SetColor( math.random(155,255), math.random(155,255), math.random(155,255) )
	...
	particle2:SetVelocity( (VectorRand() * 15) )
	...
	particle2:SetColor( math.random(155,255), math.random(155,255), math.random(155,255) )
end