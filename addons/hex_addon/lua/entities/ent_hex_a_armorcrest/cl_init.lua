...
function ENT:Initialize()
	...
	self.prop_a1:SetColor(Color(175,165,155))
	...
	self.prop_a2:SetColor(Color(175,165,155))

	self.prop_a1:SetSkin(4)
	self.prop_a2:SetSkin(4)
...
function ENT:Draw()
	...
	render.DrawSprite(self:GetPos()+Vector(0,0,15), siz*24, siz*24, Color( 175, 165, 155, 185 ))
	...
	if RealTime() > self.NextEmit then
		...
		particle:SetColor( 175, 165, 155, math.random(15,215) )
