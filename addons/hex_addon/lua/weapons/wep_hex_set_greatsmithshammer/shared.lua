...
if (CLIENT) then
	SWEP.PrintName 		= "Greatsmiths Hammer"
	SWEP.Slot 			= 1
	SWEP.SlotPos 		= 1
...
SWEP.WorldModel         = "models/morrowind/dwemer/hammer/w_dwemer_hammer.mdl"
...
-- Greatsmiths Hammer -- Elements: Holy / Storm / Fire / Earth --
-- Primary Low: Crush
-- Primary Norm: Storm Smash
-- Primary High: Hyper Smash
-- Hidden Power: Star Hammers ( Holy / Fire / Lightning / Magic Starfall Field )
