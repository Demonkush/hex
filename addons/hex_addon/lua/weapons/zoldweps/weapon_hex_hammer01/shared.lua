...
function SWEP:HammerSmash()
    ...
    if SERVER then
        self.Owner:EmitSound( "wc3sound/exp/FarseerMissile.wav", 43, math.random(85,95) )
    ...
    util.Effect( "fx_hex_hammersmash01", fx )
...
function SWEP:ThrowHammer(damage, recoil, num_bullets, aimcone)
    ...
    if SERVER then
        for i=1,num_bullets do
            ...
            local ent = ents.Create( "ent_hex_hammer01" )
    ...
    util.Effect( "MuzzleHammer01", effect )
...
if( CLIENT ) then
    ...
    effects.Register( EFFECT, "MuzzleHammer01" )
end