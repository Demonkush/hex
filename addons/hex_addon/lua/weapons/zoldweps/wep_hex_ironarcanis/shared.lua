...
-- Iron Arcanis -- Elements: Magic --
-- Primary Low: Magic Spark
-- Primary Norm: Arcane Bolt
-- Primary High: Magic Missile, Faster and stronger bolt with a straight shot.
-- Secondary Norm: Magic Bomb, Launches a charged magic bomb.
-- Secondary High: Super Magic Bomb, Larger boom and chance to fling one random elemental bolt.
...
function SWEP:DoSecondaryAttack(output)
    local projent = "ent_hex_proj_magicbomb"
    local gravity = true
