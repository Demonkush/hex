...
if (CLIENT) then
	SWEP.PrintName 		= "Highpriest Staff"
	SWEP.Slot 			= 1
	SWEP.SlotPos 		= 1
...
SWEP.WorldModel         = "models/morrowind/dwemer/halberd/w_dwemer_halberd.mdl"
...
-- Highpriest Staff -- Elements: Holy / Fire / Magic --
-- Primary Low: Heal
-- Primary Norm: Holy Light
-- Primary High: Holy Wrath
-- Hidden Power: Wrath of God ( Holy / Fire / Storm Field )
