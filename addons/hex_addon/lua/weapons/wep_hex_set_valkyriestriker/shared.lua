...
if (CLIENT) then
	SWEP.PrintName 		= "Valkyrie Striker"
	SWEP.Slot 			= 1
	SWEP.SlotPos 		= 1
...
SWEP.WorldModel         = "models/weapons/w_rif_horde_xbow.mdl"
...
-- Valkyrie Striker -- Elements: Holy / Fire / Lightning --
-- Primary Low: Fire Arrow
-- Primary Norm: Righteous Arrow
-- Primary High: Phoenix Fire
-- Hidden Power: Sunstrike ( Holy / Fire / Lightning Laser )
