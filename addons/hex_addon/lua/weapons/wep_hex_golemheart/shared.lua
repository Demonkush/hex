...
-- Golemheart -- Elements: Earth --
-- Primary Low: Rock Toss
-- Primary Norm: Boulder
-- Primary High: Molten Boulder ( Boulder with fire damage and AOE explosion )
-- Hidden Power: Meteor Aegis ( Toss molten boulder, meteor falls in front of you )
