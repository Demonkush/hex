...
-- Cursed Orb -- Elements: Shadow / Mana Drain --
-- Primary Low: Drain
-- Primary Norm: Drain Beam
-- Primary High: Soul Siphon ( constant )
-- Hidden Power: Wrathpurge ( Large Shadow / Lightning / Mana Drain Constant Laser + Homing Projectiles )
