...
if (CLIENT) then
	SWEP.PrintName 		= "Book of Darkweaving"
	SWEP.Slot 			= 1
	SWEP.SlotPos 		= 1
...
-- Book of Darkweaving -- Elements: Shadow / Mana Drain --
-- Primary Low: Drain
-- Primary Norm: Hungry Soul ( Homing projectiles )
-- Primary High: Devourer ( Explosive homing projectiles )
-- Hidden Power: Wrath of Souls ( Many Homing Projectiles )
