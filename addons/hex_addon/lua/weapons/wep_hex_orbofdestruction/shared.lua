...
if (CLIENT) then
	SWEP.PrintName 		= "Orb of Destruction"
	SWEP.Slot 			= 1
	SWEP.SlotPos 		= 1
...
SWEP.WorldModel         = "models/weapons/w_rock.mdl"
...
-- Orb of Destruction -- Elements: Fire / Lightning --
-- Primary Low: Chaos Spark
-- Primary Norm: Chaos Bolt ( Homing bolt )
-- Primary High: Destruction ( Flurry of explosive homing bolts )
-- Hidden Power: Doom ( Fire / Shadow / Lightning Homing Projectiles, Shadow / Fire Nova )
