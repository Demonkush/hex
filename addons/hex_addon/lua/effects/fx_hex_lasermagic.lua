...
function EFFECT:Render()
	...
	render.DrawBeam(self.StartPos,
					...
					CurTime()*15,
					Color(235, 155, 255, 255))
	
	render.SetMaterial(self.EndSprMat)
	render.DrawSprite(self.StartPos, self.Width*2, self.Width*2,Color(235, 155, 255, 155))
	render.DrawSprite(self.EndPos, self.Width*2, self.Width*2, Color(235, 155, 255, 155))
end
