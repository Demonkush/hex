...
function EFFECT:Render()
	...
	render.DrawSprite(self.StartPos, self.Width*6, self.Width*6,Color(235, 155, 255, 255))
	render.DrawSprite(self.EndPos, self.Width*6, self.Width*6, Color(235, 155, 255, 255))
end
