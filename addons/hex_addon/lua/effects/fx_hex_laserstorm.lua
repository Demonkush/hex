...
function EFFECT:Render()
	...
	render.DrawSprite(self.StartPos, self.Width*2, self.Width*2,Color(195, 215, 255, 155))
	render.DrawSprite(self.EndPos, self.Width*2, self.Width*2, Color(195, 215, 255, 155))
end
